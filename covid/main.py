...
os.remove('/home/danielmhl/covid19vaccinedeployment/covid/database.csv')

countries = []

index = 2
with open('/home/danielmhl/covid19vaccinedeployment/covid/database.csv', 'w', newline='') as csvfile:
...
try:
	for tr in trs:
		...
		index = index + 1
		with open('/home/danielmhl/covid19vaccinedeployment/covid/database.csv', 'a+', newline='') as csvfile:
			writer = csv.writer(csvfile)
			writer.writerow([day, country, vaccinated, percentage])
except:
	pass
...
with open ('/home/danielmhl/covid19vaccinedeployment/covid/output.csv', 'a', newline='') as csvfile:
	writer = csv.writer(csvfile)
	writer.writerow('\n')
...
try:
	for tr in trs:
		...
		index = index + 1
		with open('/home/danielmhl/covid19vaccinedeployment/covid/cases.csv' ,'a', newline='') as csvfile:
			writer = csv.writer(csvfile)
			writer.writerow([day, country, cases, deaths])
		for a in countries:
			if country == a:
				with open('/home/danielmhl/covid19vaccinedeployment/covid/database.csv', 'r', newline='') as csvfile:
					reader = csv.DictReader(csvfile)
					for row in reader:
						if row['country'] == country:
							vaccinated = row['vaccinated']
							percentage = row['percentage"']
							with open("/home/danielmhl/covid19vaccinedeployment/covid/nha.csv") as csvfile:
								reader = csv.DictReader(csvfile)
								for row1 in reader:
									...
									if a == nhacountry:
										...
										with open("/home/danielmhl/covid19vaccinedeployment/covid/economyrank.csv") as csvfile1:
											...
											for row2 in reader:
												if row2['country'] == country:
													...
													with open("/home/danielmhl/covid19vaccinedeployment/covid/output.csv", "a+") as fhandle:
